      ...
      <v-sheet height="600">
        ...
        >
          <v-card color="grey lighten-4" min-width="350px" flat>
            ...
            <v-card-text>
              <!-- Currently editing is null by default and when editing it contains id of that event -->
  ...
  methods: {
    async getEvents() {
      ...
      snapshot.forEach((doc) => {
        ...
        appData.id = doc.id;
        //pushes each data from firestore db to the events array
        events.push(appData);
      });
      this.events = events;
    },
    ...
    updateRange({ start, end }) {
      ...
      for (let i = 0; i < eventCount; i++) {
        ...
        events.push({
          ...
          color: this.color[this.rnd(0, this.color.length - 1)],
          timed: !allDay,
        });
      }
